...
const pl: typeof en = {
  ...
  SETTINGS_DIALOG: {
    ...
    DISABLE_TIME_CHECK: 'Wyłącz sprawdzanie czasu',
    DISABLE_TIME_CHECK_INFO: 'Zaznaczenie tej opcji wyłączy zliczanie godzin, a także wszelkie cele i limity godzinowe. Zniknie również pasek postepu każdego dnia.',
    DAY_TARGET: 'Cel godzin w ciągu dnia',
    DAY_TARGET_INFO: 'Oczekiwana ilość godzin w ciągu dnia. Ta wartość oznacza 100% na pasku postępu.',
    DAY_LIMIT: 'Limit godzin w ciągu dnia',
    DAY_LIMIT_INFO: 'Maksymalna dopuszczalna liczba godzin w ciągu dnia. Tworzenie nowych zadań, a także wklejenie bądź upuszczenie zadania nie będzie możliwe w przypadku gdy ten limit miałby zostać przekroczony.',
    HOURS_SUFFIX: 'godzin',
    LANGUAGE: 'Język',
    THEME: 'Motyw',
